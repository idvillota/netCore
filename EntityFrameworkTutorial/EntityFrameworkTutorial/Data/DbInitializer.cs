...
namespace EntityFrameworkTutorial.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
            new Enrollment{StudentID=1,CourseID=1050,Grade=EGrade.A},
            new Enrollment{StudentID=1,CourseID=4022,Grade=EGrade.C},
            new Enrollment{StudentID=1,CourseID=4041,Grade=EGrade.B},
            new Enrollment{StudentID=2,CourseID=1045,Grade=EGrade.B},
            new Enrollment{StudentID=2,CourseID=3141,Grade=EGrade.F},
            new Enrollment{StudentID=2,CourseID=2021,Grade=EGrade.F},
            new Enrollment{StudentID=3,CourseID=1050},
            new Enrollment{StudentID=4,CourseID=1050},
            new Enrollment{StudentID=4,CourseID=4022,Grade=EGrade.F},
            new Enrollment{StudentID=5,CourseID=4041,Grade=EGrade.C},
            new Enrollment{StudentID=6,CourseID=1045},
            new Enrollment{StudentID=7,CourseID=3141,Grade=EGrade.A},
            };
